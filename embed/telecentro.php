...
<script type="text/javascript">
    ...
    function initializePlayer(mpd) {
        ...
        if (getURL == "espnpremium") {
            ...
            keyId = "feee98fa0c7f2e48e6e476a0864f68c3";
            key = "84c28d60bc9c1827b8cdf53b839d3ab1";
        } else if (getURL == "telefe") {
            keyId = "20455b6fe127f545e37b8c16c0a556bd";
            key = "5ea3aa0b69c9e03ca2532f549bb28bff"; 
        } else if (getURL == "tyc") {
            keyId = "dbc9f74faebbbfd94dae118eefa7602e";
            key = "37efdcf6032cdb82cf4163e0989ccfce";   
        } else if (getURL == "tyc_sd") {
            keyId = "b7beb4ee3c051869cb160960a87a63ef";
            key = "50154e3b7290a2f089697616f83029cb";     
        }
